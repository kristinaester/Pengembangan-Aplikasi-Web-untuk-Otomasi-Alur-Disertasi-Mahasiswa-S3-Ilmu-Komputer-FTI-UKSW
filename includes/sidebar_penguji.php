...
<nav class="sidebar">
    <div class="sidebar-content">
        ...
        <ul class="sidebar-menu">
            ...
            <li>
                <a href="daftar_ujian.php" class="<?php echo (basename($_SERVER['PHP_SELF']) == 'daftar_ujian.php') ? 'active' : ''; ?>">
                    DAFTAR UJIAN
                </a>
            </li>
            <li>
                <a href="bimbingan.php" class="<?php echo (basename($_SERVER['PHP_SELF']) == 'bimbingan.php') ? 'active' : ''; ?>">
                    DAFTAR BIMBINGAN
                </a>
            </li>
        </ul>
