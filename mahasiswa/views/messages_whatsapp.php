 ...
 * View untuk halaman pesan dengan tampilan WhatsApp
 */
?>
<!DOCTYPE html>
<html lang="id">
                            ...
                            <?php else: ?>
                                <?php foreach ($conversations as $conv): ?>
                                    <div class="conversation-item <?php echo ($conv['unread_count'] > 0) ? 'unread' : ''; ?> <?php echo (isset($other_user) && $other_user['id'] == $conv['other_user_id']) ? 'active' : ''; ?>" 
                                         onclick="location.href='messages.php?action=conversation&with=<?php echo $conv['other_user_id']; ?>'">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="messages.php?action=send" method="POST">
                        <!-- Di modal, ganti bagian select options -->
                        <div class="mb-3">
