<?php
/**
 * File: admin/views/messages.php
 * View untuk halaman pesan admin - DIUPDATE
 */
?>
<!DOCTYPE html>
<html lang="id">
<head>
    ...
    <title>Sistem Pesan - Admin</title>
                                    ...
                                    <select class="form-select" id="receiver_id" name="receiver_id" required>
                                        ...
                                        <?php foreach ($students as $student): ?>
                                            <option value="<?php echo $student['id']; ?>" 
                                                <?php echo (isset($reply_to) && $reply_to == $student['id']) ? 'selected' : ''; ?>>
