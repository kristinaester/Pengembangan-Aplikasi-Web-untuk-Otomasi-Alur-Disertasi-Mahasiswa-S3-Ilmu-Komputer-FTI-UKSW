 ...
 * Controller untuk mengelola pesan admin - VERSI TERBARU RESPONSIF
 */
...
// Cek session admin
if (!isset($_SESSION['user_id']) || (MessageModel::getUserRole($_SESSION['user_id']) != 'admin' && MessageModel::getUserRole($_SESSION['user_id']) != 'administrator')) {
...
switch ($action) {
    ...
    default:
        ...
        $students = MessageModel::getStudents();
        break;
}
